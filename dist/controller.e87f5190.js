...
},{"sweetalert2":"node_modules/sweetalert2/dist/sweetalert2.all.js"}],"src/js/views/loginView.js":[function(require,module,exports) {
"use strict";
...
var _modalRegister = /*#__PURE__*/new WeakMap();
var _btnGotoRegister = /*#__PURE__*/new WeakMap();
var _toggleModal = /*#__PURE__*/new WeakSet();
var _showRegisterModal = /*#__PURE__*/new WeakSet();
var _addHandlerShowModal = /*#__PURE__*/new WeakSet();
var _addHandlerShowRegisterModal = /*#__PURE__*/new WeakSet();
var LoginView = /*#__PURE__*/function (_View) {
  ...
  function LoginView() {
    ...
    _classPrivateMethodInitSpec(_assertThisInitialized(_this), _addHandlerShowRegisterModal);
    _classPrivateMethodInitSpec(_assertThisInitialized(_this), _addHandlerShowModal);
    _classPrivateMethodInitSpec(_assertThisInitialized(_this), _showRegisterModal);
    _classPrivateMethodInitSpec(_assertThisInitialized(_this), _toggleModal);
    _classPrivateFieldInitSpec(_assertThisInitialized(_this), _btnLogin, {
      writable: true,
      value: document.querySelector('.nav__btn__login')
    });
    ...
    _classPrivateFieldInitSpec(_assertThisInitialized(_this), _modal, {
      writable: true,
      value: document.querySelector('.login_modal')
    });
    _classPrivateFieldInitSpec(_assertThisInitialized(_this), _form, {
      writable: true,
      value: document.querySelector('.form__login')
    });
    _classPrivateFieldInitSpec(_assertThisInitialized(_this), _btnModalClose, {
      writable: true,
      value: document.getElementsByClassName('modal__close__btn')[0]
    });
    _classPrivateFieldInitSpec(_assertThisInitialized(_this), _modalRegister, {
      writable: true,
      value: document.querySelector('.register_modal')
    });
    _classPrivateFieldInitSpec(_assertThisInitialized(_this), _btnGotoRegister, {
      writable: true,
      value: document.querySelector('.btn__goto__register')
    });
    _classPrivateMethodGet(_assertThisInitialized(_this), _addHandlerShowModal, _addHandlerShowModal2).call(_assertThisInitialized(_this));
    _classPrivateMethodGet(_assertThisInitialized(_this), _addHandlerShowRegisterModal, _addHandlerShowRegisterModal2).call(_assertThisInitialized(_this));
    return _this;
  }
  _createClass(LoginView, [{
    key: "addHandlerSignOut",
    value: /* 로그아웃 버튼 클릭시 실행할 핸들러를 등록 */
    function addHandlerSignOut(handler) {
      _classPrivateFieldGet(this, _btnLogout).addEventListener('click', handler);
    }
    ...
    key: "addHandlerSignIn",
    value: function addHandlerSignIn(handler) {
      _classPrivateFieldGet(this, _form).addEventListener('submit', function (e) {
        ...
        var formData = _toConsumableArray(new FormData(this)).map(function (data) {
          return data[1];
        });
        e.preventDefault();
        handler(formData);
    ...
    key: "showNavLoginButton",
    value: function showNavLoginButton() {
      _classPrivateFieldGet(this, _btnLogin).classList.remove('hidden');
    }
    /* nav 로그아웃 버튼 보이기 */
  }, {
    key: "showNavLogOutButton",
...
function _toggleModal2() {
  _classPrivateFieldGet(this, _modal).classList.toggle('hidden');
  _classPrivateFieldGet(this, _modal).classList.toggle('fadein');
}
function _showRegisterModal2() {
  _classPrivateMethodGet(this, _toggleModal, _toggleModal2).call(this);
  _classPrivateFieldGet(this, _modalRegister).classList.toggle('hidden');
  _classPrivateFieldGet(this, _modalRegister).classList.toggle('fadein');
}
function _addHandlerShowModal2() {
  _classPrivateFieldGet(this, _btnLogin).addEventListener('click', _classPrivateMethodGet(this, _toggleModal, _toggleModal2).bind(this));
  _classPrivateFieldGet(this, _btnModalClose).addEventListener('click', _classPrivateMethodGet(this, _toggleModal, _toggleModal2).bind(this));
}
function _addHandlerShowRegisterModal2() {
  _classPrivateFieldGet(this, _btnGotoRegister).addEventListener('click', _classPrivateMethodGet(this, _showRegisterModal, _showRegisterModal2).bind(this));
}
var _default = new LoginView();
exports.default = _default;
},{"./View.js":"src/js/views/View.js"}],"src/js/views/registerView.js":[function(require,module,exports) {
"use strict";
...
var _form = /*#__PURE__*/new WeakMap();
var _btnModalClose = /*#__PURE__*/new WeakMap();
var _pswInput = /*#__PURE__*/new WeakMap();
var _pswChkInput = /*#__PURE__*/new WeakMap();
var _addHandlerShowModal = /*#__PURE__*/new WeakSet();
var _toggleModal = /*#__PURE__*/new WeakSet();
var _validatePassword = /*#__PURE__*/new WeakSet();
var RegisterView = /*#__PURE__*/function (_View) {
  _inherits(RegisterView, _View);
  ...
  function RegisterView() {
     ...
     */
    _classPrivateMethodInitSpec(_assertThisInitialized(_this), _validatePassword);
    _classPrivateMethodInitSpec(_assertThisInitialized(_this), _toggleModal);
    /* 회원가입 모달 창 여닫기 기능 */
    _classPrivateMethodInitSpec(_assertThisInitialized(_this), _addHandlerShowModal);
    _classPrivateFieldInitSpec(_assertThisInitialized(_this), _modal, {
    ...
    _classPrivateFieldInitSpec(_assertThisInitialized(_this), _form, {
      writable: true,
      value: document.querySelector('.form__register')
    });
    _classPrivateFieldInitSpec(_assertThisInitialized(_this), _btnModalClose, {
      writable: true,
      value: document.getElementsByClassName('modal__close__btn')[1]
    });
    _classPrivateFieldInitSpec(_assertThisInitialized(_this), _pswInput, {
      writable: true,
      value: document.querySelector('.reg__input__psw')
    });
    _classPrivateFieldInitSpec(_assertThisInitialized(_this), _pswChkInput, {
      writable: true,
      value: document.querySelector('.reg__input__psw__check')
    });
    _classPrivateMethodGet(_assertThisInitialized(_this), _addHandlerShowModal, _addHandlerShowModal2).call(_assertThisInitialized(_this));

    /* 비밀번호 일치여부 확인 이벤트 등록 */
    _classPrivateFieldGet(_assertThisInitialized(_this), _pswInput).addEventListener('change', _classPrivateMethodGet(_assertThisInitialized(_this), _validatePassword, _validatePassword2).bind(_assertThisInitialized(_this)));
    _classPrivateFieldGet(_assertThisInitialized(_this), _pswChkInput).addEventListener('keyup', _classPrivateMethodGet(_assertThisInitialized(_this), _validatePassword, _validatePassword2).bind(_assertThisInitialized(_this)));
    return _this;
  }
  _createClass(RegisterView, [{
    key: "addHandlerCreateAccount",
    value:
    /**
     *
     ...
     */
    function addHandlerCreateAccount(handler) {
      _classPrivateFieldGet(this, _form).addEventListener('submit', function (e) {
        // 이벤트 리스너의 this는 이벤트를 감지한 해당 요소임
        // FormData 객체는 form의 input 요소들을 ['name', 'value'] 형태로 매핑해 준다.
        var formData = _toConsumableArray(new FormData(this)).map(function (data) {
...
function _validatePassword2() {
  if (_classPrivateFieldGet(this, _pswInput).value !== _classPrivateFieldGet(this, _pswChkInput).value) {
    // 브라우저 API인 setCustomValidity를 사용하여 오류 메시지를 표시하고 폼이 제출되지 않게 함
    _classPrivateFieldGet(this, _pswChkInput).setCustomValidity('비밀번호가 일치하지 않습니다');
  } else {
    // 오류 메시지를 비워주어야 폼이 제출됨
    _classPrivateFieldGet(this, _pswInput).setCustomValidity('');
    _classPrivateFieldGet(this, _pswChkInput).setCustomValidity('');
  }
}
var _default = new RegisterView();
exports.default = _default;
},{"./View.js":"src/js/views/View.js"}],"node_modules/process/browser.js":[function(require,module,exports) {
...
},{}],"node_modules/@firebase/auth/dist/esm2017/index-680e2b70.js":[function(require,module,exports) {
"use strict";
...
exports.A = void 0;
exports.B = deleteUser;
exports.F = exports.E = exports.D = exports.C = void 0;
exports.G = initializeAuth;
exports.H = connectAuthEmulator;
exports.Y = exports.X = exports.W = exports.V = exports.U = exports.T = exports.S = exports.R = exports.Q = exports.P = exports.O = exports.N = exports.M = exports.L = exports.K = exports.J = exports.I = void 0;
exports.Z = signInAnonymously;
exports._ = signInWithCredential;
exports.a = void 0;
exports.a0 = reauthenticateWithCredential;
exports.a1 = signInWithCustomToken;
exports.a2 = sendPasswordResetEmail;
exports.a3 = confirmPasswordReset;
exports.a4 = applyActionCode;
exports.a5 = checkActionCode;
exports.a6 = verifyPasswordResetCode;
exports.a7 = createUserWithEmailAndPassword;
exports.a8 = signInWithEmailAndPassword;
exports.a9 = sendSignInLinkToEmail;
exports.aA = void 0;
exports.aB = _getInstance;
exports.aC = _persistenceKeyName;
exports.aD = _getRedirectResult;
exports.aE = _overrideRedirectResult;
exports.aF = _clearRedirectOutcomes;
exports.aG = _castAuth;
exports.aI = exports.aH = void 0;
exports.aJ = _getClientVersion;
exports.aK = _generateEventId;
exports.aN = exports.aM = exports.aL = void 0;
exports.aa = isSignInWithEmailLink;
exports.ab = signInWithEmailLink;
exports.ac = fetchSignInMethodsForEmail;
exports.ad = sendEmailVerification;
exports.ae = verifyBeforeUpdateEmail;
exports.af = void 0;
exports.ag = parseActionCodeURL;
exports.ah = updateProfile;
exports.ai = updateEmail;
exports.aj = updatePassword;
exports.ak = getIdToken;
exports.al = getIdTokenResult;
exports.am = unlink;
exports.an = getAdditionalUserInfo;
exports.ao = reload;
exports.ap = getMultiFactorResolver;
exports.aq = multiFactor;
exports.ar = debugAssert;
exports.as = _isIOS;
exports.at = _isAndroid;
exports.au = _fail;
exports.av = _getRedirectUrl;
exports.aw = _getProjectConfig;
exports.ax = _isIOS7Or8;
exports.ay = _createError;
exports.az = _assert;
exports.b = void 0;
...
exports.t = onIdTokenChanged;
exports.u = updatePhoneNumber;
exports.v = beforeAuthStateChanged;
exports.w = onAuthStateChanged;
exports.x = useDeviceLanguage;
exports.y = updateCurrentUser;
exports.z = signOut;
var _util = require("@firebase/util");
var _app = require("@firebase/app");
var _logger = require("@firebase/logger");
 ...
 * @public
 */
exports.C = debugErrorMap;
const prodErrorMap = _prodErrorMap;
exports.D = prodErrorMap;
 ...
 * limitations under the License.
 */
exports.E = AUTH_ERROR_CODES_MAP_DO_NOT_USE_INTERNALLY;
...
exports.Q = FacebookAuthProvider;
...
Object.defineProperty(exports, "updateEmail", {
  enumerable: true,
  get: function () {
    return _index680e2b.ai;
  }
});
Object.defineProperty(exports, "updatePassword", {
  enumerable: true,
  get: function () {
    return _index680e2b.aj;
  }
});
...
Object.defineProperty(exports, "verifyBeforeUpdateEmail", {
  enumerable: true,
  get: function () {
    return _index680e2b.ae;
  }
});
Object.defineProperty(exports, "verifyPasswordResetCode", {
  enumerable: true,
  get: function () {
    return _index680e2b.a6;
  }
});
var _index680e2b = require("./index-680e2b70.js");
require("@firebase/util");
require("@firebase/app");
require("@firebase/logger");
require("tslib");
require("@firebase/component");
},{"./index-680e2b70.js":"node_modules/@firebase/auth/dist/esm2017/index-680e2b70.js","@firebase/util":"node_modules/@firebase/util/dist/index.esm2017.js","@firebase/app":"node_modules/@firebase/app/dist/esm/index.esm2017.js","@firebase/logger":"node_modules/@firebase/logger/dist/esm/index.esm2017.js","tslib":"node_modules/tslib/tslib.es6.js","@firebase/component":"node_modules/@firebase/component/dist/esm/index.esm2017.js"}],"node_modules/firebase/auth/dist/esm/index.esm.js":[function(require,module,exports) {
"use strict";
...
},{"@firebase/auth":"node_modules/@firebase/auth/dist/esm2017/index.js"}],"src/js/auth.js":[function(require,module,exports) {
"use strict";
...
function _classPrivateFieldGet(receiver, privateMap) { var descriptor = _classExtractFieldDescriptor(receiver, privateMap, "get"); return _classApplyDescriptorGet(receiver, descriptor); }
function _classExtractFieldDescriptor(receiver, privateMap, action) { if (!privateMap.has(receiver)) { throw new TypeError("attempted to " + action + " private field on non-instance"); } return privateMap.get(receiver); }
function _classApplyDescriptorGet(receiver, descriptor) { if (descriptor.get) { return descriptor.get.call(receiver); } return descriptor.value; } // Import the functions you need from the SDKs you need
// TODO: Add SDKs for Firebase products that you want to use
// https://firebase.google.com/docs/web/setup#available-libraries
var _firebaseConfig = /*#__PURE__*/new WeakMap();
var _firebase_app = /*#__PURE__*/new WeakMap();
...
var Auth = /*#__PURE__*/function () {
  function Auth() {
    ...
    // Initialize Firebase
    _classPrivateFieldInitSpec(this, _firebase_app, {
      writable: true,
      value: (0, _app.initializeApp)(_classPrivateFieldGet(this, _firebaseConfig))
    });
    _classPrivateFieldInitSpec(this, _auth, {
      writable: true,
      value: (0, _auth2.getAuth)(_classPrivateFieldGet(this, _firebase_app))
    });
  }
  _createClass(Auth, [{
    key: "signUpEmail",
    value: function () {
      var _signUpEmail = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(email, password) {
        var data;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.prev = 0;
              _context.next = 3;
              return (0, _auth2.createUserWithEmailAndPassword)(_classPrivateFieldGet(this, _auth), email, password);
            case 3:
              data = _context.sent;
              console.log(data);
      ...
      function signUpEmail(_x, _x2) {
        return _signUpEmail.apply(this, arguments);
      }
      return signUpEmail;
    }()
  }, {
    key: "signInEmail",
    value: function () {
      var _signInEmail = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(email, password) {
        var data;
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              _context2.prev = 0;
              _context2.next = 3;
              return (0, _auth2.signInWithEmailAndPassword)(_classPrivateFieldGet(this, _auth), email, password);
            case 3:
              data = _context2.sent;
              console.log(data);
      ...
      function signInEmail(_x3, _x4) {
        return _signInEmail.apply(this, arguments);
      }
      return signInEmail;
    }()
  }, {
    key: "signOutUser",
    value: function () {
      var _signOutUser = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              _context3.prev = 0;
              _context3.next = 3;
              return (0, _auth2.signOut)(_classPrivateFieldGet(this, _auth));
            case 3:
              _context3.next = 8;
              break;
            case 5:
    ...
    key: "onUserStateChange",
    value: function onUserStateChange(handler) {
      (0, _auth2.onAuthStateChanged)(_classPrivateFieldGet(this, _auth), function (user) {
        handler(user);
      });
    }
  }, {
...
exports.default = _default;
},{"firebase/app":"node_modules/firebase/app/dist/esm/index.esm.js","firebase/auth":"node_modules/firebase/auth/dist/esm/index.esm.js"}],"src/js/controller.js":[function(require,module,exports) {
"use strict";

var _loginView = _interopRequireDefault(require("./views/loginView.js"));
var _registerView = _interopRequireDefault(require("./views/registerView.js"));
 ...
 *
 */
var controlSignIn = /*#__PURE__*/function () {
...
/* 로그아웃 버튼 클릭 이벤트 핸들러 */
var controlSignOut = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.prev = 0;
          _context3.next = 3;
          return _auth.default.signOutUser();
        case 3:
          _loginView.default.renderSuccessMessage("로그아웃되었습니다");
          _context3.next = 10;
          break;
        case 6:
          _context3.prev = 6;
          ...
          _loginView.default.renderError("로그아웃 실패");
        case 10:
        case "end":
          return _context3.stop();
      }
  ...
  return function controlSignOut() {
 ...
 */
var controlUserStateChange = function controlUserStateChange(user) {
...
var init = function init() {
  _auth.default.onUserStateChange(controlUserStateChange);
  _registerView.default.addHandlerCreateAccount(controlCreateAccount);
  _loginView.default.addHandlerSignIn(controlSignIn);
  _loginView.default.addHandlerSignOut(controlSignOut);
};
init();
},{"./views/loginView.js":"src/js/views/loginView.js","./views/registerView.js":"src/js/views/registerView.js","./auth.js":"src/js/auth.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
